                            ...
                            <div class="dropdown-menu show">
                                <nav class="side-nav">
                                    ...
                                    @foreach($categories as $category)
                                        <li><a href="{{ url('/categories/'.str_replace(' ', '-', $category->category_name)) }}">{{ $category->category_name }}</a></li>
                                    @endforeach
            ...
            <div class="form-box">
                <div class="form-tab">
                    ...
                    <div class="tab-content" id="tab-content-5">
                        <div class="tab-pane fade show active" id="signin" role="tabpanel" aria-labelledby="signin-tab">
                            ...
                            @csrf
                                ...
                                <div class="form-footer">
                                    <button type="button" class="btn btn-outline-primary-2 btn-login">
                                        <span>LOG IN</span>
                        ...
                        <div class="alert alert-success alert-dismissible msg-div" role="alert" style="display:none;">
                            <span class="success-msg"></span>
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                            <!-- <form method="POST" action="{{ url('customer_register') }}" id="register-form"> -->
                            <form id="register-form">
                            @csrf
                                <div class="form-group">
                                    <label for="name">Your username *</label>
                                    <input type="text" class="form-control" id="name" name="name" required>
                                    <span class="name_error small text-danger"></span>
                                </div><!-- End .form-group -->

                                <div class="form-group">
                                    <label for="register-email">Your email address *</label>
                                    <input type="email" class="form-control" id="register-email" name="email" required>
                                    <span class="email_error small text-danger"></span>
                                </div><!-- End .form-group -->

                                <div class="form-group">
                                    <label for="register-password">Password *</label>
                                    <input type="password" class="form-control" id="register-password" name="password" required>
                                    <span class="password_error small text-danger"></span>
                                </div><!-- End .form-group -->

                                <div class="form-group">
                                    <label for="confirm_password">Confirm Password *</label>
                                    <input type="password" class="form-control" id="confirm_password" name="confirm_password" required>
                                    <span class="confirm_password_error small text-danger"></span>
                                </div><!-- End .form-group -->

                                <div class="form-footer">
                                    <button type="button" class="btn btn-outline-primary-2 btn-register">
                                        <span>SIGN UP</span>
                                        <i class="icon-long-arrow-right"></i>
                                    </button>
