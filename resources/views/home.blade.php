                ...
                <div class="cat-blocks-container">
                    ...
                    @foreach($categories as $category)
                        <div class="col-6 col-sm-4 col-lg-2">
                            <a href="{{ url('/categories/'.str_replace(' ', '-', $category->category_name)) }}" class="cat-block">
                                <figure>
                                    <span>
                                        <img src="{{ asset('uploads/categories/'.$category->category_image) }}" alt="{{ $category->category_name }}">
                                    </span>
                                </figure>
                        ...
                        <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl" 
                            ...
                            <div class="product">
                                ...
                                <div class="product-body">
                                    ...
                                    <h3 class="product-title"><a href="{{ url('single/'.str_replace(' ', '-', $item->Product_Name)) }}">{{ $item->Product_Name }}</a></h3><!-- End .product-title -->
