                                            ...
                                            <div class="form-row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control py-4" id="Price" type="number" name="price" placeholder="Enter Product Price here" Required="required" />
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control py-4" id="Stock" type="number" name="stock" placeholder="Enter Product Stock here" Required="required" />
